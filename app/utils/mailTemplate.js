                    ...
                    <tr style="max-height: 180px;">
                        <td align="center" valign="top" style="padding: 15px 0 0 0; display: flex; justify-content: center;" class="logo">
                            <a href=${CLIENT_URL} target="_blank" style="padding: 0; width: 100%; text-align: center;">
                                <img alt="parkbuilder" src="https://raw.githubusercontent.com/rifkegribenes/parkbuilder/master/client/public/img/parkbuilder.png" style="display: block; margin: auto; width:100%; max-width: 500px; height: auto; max-height: 180px;" border="0">
                            </a>
                        </td>
                    </tr>
                </table>
...
exports.pwResetTemplate = (url) => {
     return shortEmail(
      ...
      'https://raw.githubusercontent.com/rifkegribenes/parkbuilder/master/client/public/img/email-banner.png', // heroUrl
      'No problem! Click below to reset it!', // body
      'Reset Password', // buttonText
      'parkbuilder | rifkegribenes.io' // footerText
      );
 };
...
exports.pwResetConfirmation = () => {
     return shortEmail(
      ...
      'https://raw.githubusercontent.com/rifkegribenes/parkbuilder/master/client/src/img/checkbox_500x180.png', // heroUrl
